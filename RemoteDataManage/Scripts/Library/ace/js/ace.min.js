...
ace.settings = {
    ...
    sidebar_collapsed: function (c) {
        ...
        var d = document.getElementById("sidebar-collapse").querySelector('[class*="iconN-"]');
    ...
    function (h) {
        ...
        if (!a(f).is(":visible")) {
            ...
            d.find("> .active > .submenu").each(function () {
                if (this != f) {
                    a(this).hide().parent().removeClass("active")
                    a(this).parent().find(".arrow").removeClass("ui-icon-carat-1-w")
                }
            })
        } else { }
        ...
        a(f).toggle().parent().toggleClass("active");
        a(f).parent().find(".arrow").toggleClass("ui-icon-carat-1-w")
        return false
    })
};